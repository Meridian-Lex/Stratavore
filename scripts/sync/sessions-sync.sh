#!/bin/bash
# Sync V2 time_sessions.jsonl → V3 sessions table (idempotent)
#
# Usage:
#   ./sessions-sync.sh [v2-dir] [stratavore-migrate-binary]
#
# Defaults:
...
echo "=== Stratavore V2→V3 Sessions Sync ==="
